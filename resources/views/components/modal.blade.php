...
>
    ...
    <div
        x-show="show"
        class="mb-6 glass-card rounded-2xl overflow-hidden shadow-2xl transform transition-all sm:w-full {{ $maxWidth }} sm:mx-auto border border-gray-200 dark:border-gray-700 glow"
        x-transition:enter="ease-out duration-300"
